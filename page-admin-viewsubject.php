				...
				<div align="center">
					...
					<table border="2" id="tablestyle">
                     ...
                     Print '<tr>
                        <td>'.$row['sub_name'].'</td>
                        <td>'.$row['sub_price'].'</td>
                        <td><a href="page-admin-updatesubject.php?id='.$row['sub_name'].'">Update</a></td>
                        <td><a onclick="javascript:confirmationDelete($(this));return false;" href="deleteSubject.php?id='.$row['sub_name'].'">Delete</a></td>
                     </tr>';
                   }
                ?>
					</table>
