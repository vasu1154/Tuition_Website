							...
							<form class="white-row" method="post" action="page-student-update1.php?id=<?php echo $id;?>">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Full Name<input type="text" name="stdname" class="form-control" value="<?php echo $row['stu_name']; ?>"required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												School<input type="text" name="stdcategory" class="form-control" value="<?php echo $row['stu_category']; ?>"required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div class="col-md-6">
													Gender<br>
													<select name="stdgender" required>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Email<input type="text" name="stdemail" class="form-control" value="<?php echo $row['stu_email']; ?>" required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Address<textarea name="stdaddress" class="form-control" required><?php echo $row['stu_address']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Phone Number<input type="text" name="stdphone" class="form-control" value="<?php echo $row['stu_phone_num']; ?>"required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Parent Phone Number<input type="text" name="stdtel" class="form-control" value="<?php echo $row['stu_parent_phone_num']; ?>"required>
											</div>
										</div>
									</div>
