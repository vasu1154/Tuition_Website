					...
					<div align="center">
						<form name="subject-registration-form" action="student-subject-reg.php?id=<?php echo $id;?>" method="post">
							<select name="subject">
		                       ...
		                       print '<option value="'.$row['sub_name'].'">'.$row['sub_name'].'</option>';}
		                       ?>
					...
					<div align="center">
						<table border="2" id="tablestyle">
							...
							<?php
		                       ...
		                       $sql = "SELECT S.stu_id,  P.sub_name , P.sub_price FROM student S, sub P , learn L WHERE S.stu_id = L.stu_id AND L.sub_name = P.sub_name AND S.stu_id='$id'";
		                       $count=0;
		                       $result = mysqli_query($db, $sql);
		                       ...
		                       print '<tr>
		                       		<td>'.$row['sub_name'].'</td>
		                       		<td>'.$row['sub_price'].'</td>
		                       		<td><a href="student-delete-subject.php?id='.$id.'&subname='.$row['sub_name'].'">Drop</a></td>
		                       </tr>
		                       ';
								$count = $count + $row['sub_price'];
		                   }
