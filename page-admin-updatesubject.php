			...
			<div class="padding60">
				...
				<section class="container">
					...
					<div class="row">
                       ...
                       $sql = "SELECT * FROM `sub` WHERE `sub_name`='$id'";
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="subname" class="form-control" value="<?php echo $row['sub_name'];?>">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="subprice" class="form-control" value="<?php echo $row['sub_price'];?>">
										</div>
									</div>
								</div>
								<div class="row">
