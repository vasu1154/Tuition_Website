				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							<li class="active"><a href="page-admin-teacher-approvement-form2.php">Teacher Approvement</a></li>
			...
			<section id="" class="padding60">
				...
				<div class="container">
					...
					<?php
                       ...
                       $sql = "SELECT * from temp_teacher WHERE '$id'=tcr_id";
                       ...
                       Print '
						...
						<form name="approvement-form" action="approvement.php" method="post">
								...
								<input type="text" name="tcrid" value="'.$row['tcr_id'].'" readonly="readonly" hidden>
								<input type="text" name="tcrpass" value="'.$row['tcr_password'].'" readonly="readonly" hidden>
								<tr>
									<td>Teacher Name</td>
									<td><input type="text" name="tcrname" value="'.$row['tcr_name'].'" readonly="readonly" class="form-control"></td>
								</tr>
								<tr>
									<td>Subject</td>
									<td><input type="text" name="tcrsub" value="'.$row['tcr_sub'].'" readonly="readonly" class="form-control"></td>
								</tr>
								<tr>
									<td>Gender</td>
									<td><input type="text" name="tcrgender" value="'.$row['tcr_sex'].'" readonly="readonly" class="form-control"></td>
								</tr>
								<tr>
									<td>Category</td>
									<td><input type="text" name="tcrcat" value="'.$row['tcr_cat'].'" readonly="readonly" class="form-control"></td>
								</tr>
								<tr>
									<td>Email</td>
									<td><input type="text" name="tcremail" value="'.$row['tcr_email'].'" readonly="readonly " class="form-control"></td>
								</tr>
								<tr>
									<td>Address</td>
									<td><input type="text" name="tcraddress" value="'.$row['tcr_address'].'" readonly="readonly" class="form-control"></td>
								</tr>
								<tr>
									<td>Phone Number</td>
									<td><input type="text" name="tcrphone" value="'.$row['tcr_telnum'].'" readonly="readonly" class="form-control"></td>
								</tr>
				...
				?>
					...
					<div align="center">
							<br>
							<!-- <?php print'<a onclick="javascript:confirmationAapprove($(this));return true;" href="approvement.php?id='.$id.'"><input type="button" name="approve" value="Approve" class="btn btn-primary" ></a>';?> -->
							<input type="submit" name="btnapprove" value="Approve" class="btn btn-primary" href="approvement.php?id='.$id.'" >
